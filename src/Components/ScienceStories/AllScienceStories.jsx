...
function AllScienceStories({ filteredBtnText }) {
  ...
  console.log(FakeDataFetched)
  const dataFetched = useSelector((state) => state.Story.data);
  const [ FakeData ,setFakeData ] = useState([])


  useEffect(() => {
    if(FakeDataFetched.length > 0 && FakeDataFetched !== null && FakeDataFetched !== undefined){
      console.log("------------------- FakeData before FakeDataFetched ----" , FakeData )
