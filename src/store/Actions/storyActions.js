...
export const SciencefetchData = createAsyncThunk("data/SciencefetchData", async () => {
  try {
...
export const FantasyfetchData = createAsyncThunk("data/FantasyfetchData", async () => {
  try {
    const response = await axios.get("fantasy");
    //   console.log(response.data)
    return response.data;
...
export const MysteryfetchData = createAsyncThunk("data/MysteryfetchData", async () => {
  try {
    const response = await axios.get("/mystery");
    // console.log(response.data)
    return response.data;
...
export const HistoryfetchData = createAsyncThunk("data/HistoryfetchData", async () => {
  try {
    const response = await axios.get("historyfiction");
    // console.log(response.data)
    return response.data;
...
export const SportfetchData = createAsyncThunk("data/SportfetchData", async () => {
  try {
    const response = await axios.get("/sportfiction");
    // console.log(response.data)
    return response.data;
...
export const Get_Copied_Data = createAsyncThunk("data/Get_Copied_Data" , async (formData) => {
  try {
